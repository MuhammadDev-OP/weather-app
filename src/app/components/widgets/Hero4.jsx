...
const Hero4 = () => {
    return (
        <div className="relative flex flex-col min-h-[70VH] items-center justify-center w-full bg-cover bg-center bg-no-repeat bg-blend-overlay bg-black/30" style={{ backgroundImage: 'url(/hero4.jpg)' }}>
